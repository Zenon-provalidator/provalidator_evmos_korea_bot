...
const botJob = new CronJob(`*/60 * * * * *`, async function () {
	...
	if(latestProposal !== 0 ){
		...
		if(typeof getProposal === "object"){
			...
			msg += `📌<a href='https://www.mintscan.io/evmos/proposals/${callProposalNum}'>https://www.mintscan.io/evmos/proposals/${callProposalNum}</a>\n\n`
